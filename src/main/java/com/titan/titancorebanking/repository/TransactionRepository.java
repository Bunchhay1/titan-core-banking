...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
    ...
    // ✅ Find transactions from an account after a given timestamp (for budget analysis)
    List<Transaction> findByFromAccountAndTimestampAfter(
            com.titan.titancorebanking.model.Account fromAccount, LocalDateTime timestamp);
